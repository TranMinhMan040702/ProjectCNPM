				...
				<form>
						...
						<div class="form-row">
							<div class="col">
								<label>Họ tên</label> <input type="text" class="form-control"
									placeholder="Tên của bạn" required name="">
							</div>
							<div class="col">
								<label>Giới tính:</label> <br> <label><input type="radio"
									value="nam" name="gioi-tinh" checked> Nam</label> <label><input
									type="radio" name="gioi-tinh" value="nu"> Nữ</label>
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>Ngày sinh</label> <input type="date" class="form-control"
							placeholder="Ngày sinh của bạn" required name="">
					</div>
					<div class="form-group">
						<div class="form-row">
							<div class="col">
					...
					<div class="form-group">
						<div class="form-row">
							...
							<div class="col">
								<label>Khoa</label> <select id="departments" class="form-control">
					...
					<div class="form-group">
						...
						<a style="margin-left: 52%;" href="Change_Password.jsp"><i
